		...
		<div className='fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-opacity'>
			<div className='bg-white rounded-xl p-6 w-11/12 max-w-sm text-center shadow-lg'>
				...
				<div className='flex flex-col gap-3'>
					<button onClick={onCancel} className='bg-neutral-300 text-black py-2 rounded-md font-medium hover:bg-neutral-400 transition cursor-pointer'>
						Cancel
					</button>
					<button onClick={onConfirm} className='bg-red-600 text-white py-2 rounded-md font-medium hover:bg-red-700 transition cursor-pointer'>
						Logout
					</button>
				</div>
			</div>
